...
import com.jlmd.simpleneuralnetwork.neuralnetwork.exception.NotSameInputOutputSizeException;
import com.jlmd.simpleneuralnetwork.neuralnetwork.exception.ZeroInputDimensionException;
import com.jlmd.simpleneuralnetwork.neuralnetwork.exception.ZeroInputElementsException;
...
/**
 * Engine of neural network. This class do all necessary work to learn from
 * input and output data and generate a result
 * 
 * @author jlmd
 */
public class NeuralNetwork {
	...
	public NeuralNetwork(float[][] inputs, float[] t, INeuralNetworkCallback neuralNetworkCallback) {
	...
	/**
	 * Starts a asynchronous thread for do all neural network work Calls a
	...
	/**
	 * Kernel of neural network. This code run on a separate thread and do all
	 * necessary work to make the neural network learn.
	 */
